"""Contracts for Bestbeat telemetry (JSON payloads, limits per F0-09 / api_antiga)."""
...
class BestbeatEventIn(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class EventsBatchIn(BaseModel):
    events: Annotated[list[BestbeatEventIn], Field(min_length=1, max_length=500)]
